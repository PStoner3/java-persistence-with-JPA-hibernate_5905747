...
-- This code is for module 07_01 of the Java Performance Linkedin Learning course.
-- USE library;
-- CREATE TABLE IF NOT EXISTS book_type(
--   type_code VARCHAR(255),
--   type_subcode VARCHAR(255),
...
--   PRIMARY KEY(type_code, type_subcode)
-- );
-- ALTER TABLE IF EXISTS book_type
-- ADD PRIMARY KEY IF NOT EXISTS  (type_code, type_subcode);
